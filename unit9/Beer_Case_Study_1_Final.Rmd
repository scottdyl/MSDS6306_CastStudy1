...
# This is the code Sadik used to answer question 8
...
knnipa <- knn(trainIpa[, c(7,8)],testIpa[, c(7,8)],cl=trainIpa$Style,k=14,prob = TRUE)

ipamatrix <- confusionMatrix(knnipa,bud_data_clean$Style)
ipamatrix
